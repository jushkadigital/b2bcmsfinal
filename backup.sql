...
--
-- Name: categorias; Type: TABLE; Schema: public; Owner: strapi
--
...
ALTER TABLE public.categorias OWNER TO strapi;

--
-- Name: categorias_id_seq; Type: SEQUENCE; Schema: public; Owner: strapi
--
...
ALTER TABLE public.categorias_id_seq OWNER TO strapi;

--
-- Name: categorias_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: strapi
--
...
--
-- Name: paquetess_user_lnk; Type: TABLE; Schema: public; Owner: strapi
--

CREATE TABLE public.paquetess_user_lnk (
    id integer NOT NULL,
    paquetes_id integer,
    user_id integer,
    paquetes_ord double precision
);


ALTER TABLE public.paquetess_user_lnk OWNER TO strapi;

--
-- Name: paquetess_user_lnk_id_seq; Type: SEQUENCE; Schema: public; Owner: strapi
--

CREATE SEQUENCE public.paquetess_user_lnk_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.paquetess_user_lnk_id_seq OWNER TO strapi;

--
-- Name: paquetess_user_lnk_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: strapi
--

ALTER SEQUENCE public.paquetess_user_lnk_id_seq OWNED BY public.paquetess_user_lnk.id;
...
--
-- Name: tourss; Type: TABLE; Schema: public; Owner: strapi
--

CREATE TABLE public.tourss (
    id integer NOT NULL,
    document_id character varying(255),
    title character varying(255),
    precio numeric(10,2),
...
ALTER TABLE public.tourss OWNER TO strapi;

--
-- Name: tourss_categorias_lnk; Type: TABLE; Schema: public; Owner: strapi
--

CREATE TABLE public.tourss_categorias_lnk (
    id integer NOT NULL,
    tours_id integer,
    categoria_id integer,
    categoria_ord double precision,
    tours_ord double precision
);


ALTER TABLE public.tourss_categorias_lnk OWNER TO strapi;

--
-- Name: tourss_categorias_lnk_id_seq; Type: SEQUENCE; Schema: public; Owner: strapi
--

CREATE SEQUENCE public.tourss_categorias_lnk_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.tourss_categorias_lnk_id_seq OWNER TO strapi;

--
-- Name: tourss_categorias_lnk_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: strapi
--

ALTER SEQUENCE public.tourss_categorias_lnk_id_seq OWNED BY public.tourss_categorias_lnk.id;


--
-- Name: tourss_cmps; Type: TABLE; Schema: public; Owner: strapi
--

CREATE TABLE public.tourss_cmps (
    id integer NOT NULL,
    entity_id integer,
    cmp_id integer,
    component_type character varying(255),
...
ALTER TABLE public.tourss_cmps OWNER TO strapi;

--
-- Name: tourss_cmps_id_seq; Type: SEQUENCE; Schema: public; Owner: strapi
--

CREATE SEQUENCE public.tourss_cmps_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.tourss_cmps_id_seq OWNER TO strapi;

--
-- Name: tourss_cmps_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: strapi
--

ALTER SEQUENCE public.tourss_cmps_id_seq OWNED BY public.tourss_cmps.id;


--
-- Name: tourss_destino_lnk; Type: TABLE; Schema: public; Owner: strapi
--

CREATE TABLE public.tourss_destino_lnk (
    id integer NOT NULL,
    tours_id integer,
    destino_id integer
);
...
ALTER TABLE public.tourss_destino_lnk OWNER TO strapi;

--
-- Name: tourss_destino_lnk_id_seq; Type: SEQUENCE; Schema: public; Owner: strapi
--

CREATE SEQUENCE public.tourss_destino_lnk_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.tourss_destino_lnk_id_seq OWNER TO strapi;

--
-- Name: tourss_destino_lnk_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: strapi
--

ALTER SEQUENCE public.tourss_destino_lnk_id_seq OWNED BY public.tourss_destino_lnk.id;


--
-- Name: tourss_id_seq; Type: SEQUENCE; Schema: public; Owner: strapi
--

CREATE SEQUENCE public.tourss_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.tourss_id_seq OWNER TO strapi;

--
-- Name: tourss_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: strapi
--

ALTER SEQUENCE public.tourss_id_seq OWNED BY public.tourss.id;
...
--
-- Name: categorias id; Type: DEFAULT; Schema: public; Owner: strapi
--
...
--
-- Name: paquetess_user_lnk id; Type: DEFAULT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.paquetess_user_lnk ALTER COLUMN id SET DEFAULT nextval('public.paquetess_user_lnk_id_seq'::regclass);
...
--
-- Name: tourss id; Type: DEFAULT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.tourss ALTER COLUMN id SET DEFAULT nextval('public.tourss_id_seq'::regclass);


--
-- Name: tourss_categorias_lnk id; Type: DEFAULT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.tourss_categorias_lnk ALTER COLUMN id SET DEFAULT nextval('public.tourss_categorias_lnk_id_seq'::regclass);


--
-- Name: tourss_cmps id; Type: DEFAULT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.tourss_cmps ALTER COLUMN id SET DEFAULT nextval('public.tourss_cmps_id_seq'::regclass);


--
-- Name: tourss_destino_lnk id; Type: DEFAULT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.tourss_destino_lnk ALTER COLUMN id SET DEFAULT nextval('public.tourss_destino_lnk_id_seq'::regclass);
...
215	nnfpw2haz8fekreg6sp6luc3	plugin::content-manager.explorer.create	{}	api::nosotros.nosotros	{"fields": ["fondo", "titulo", "subtitulo", "imagenParrafo", "puv.puv", "puv.nombre", "puv.imagen", "intermedioSubtitulo", "intermedioMensaje", "mision", "vision", "razonSocial", "ruc", "nombreComercial", "tituloAutorizaciones", "autorizaciones", "tituloValores", "valores.imagen", "valores.label", "tituloPartners", "partners", "tituloCertificados", "certificados", "tituloEstadisticas", "estadisticas.redLetras", "estadisticas.grayLetras", "parrafo"], "locales": ["en", "es-PE"]}	[]	2025-01-06 01:39:41.729	2025-01-06 01:39:41.729	2025-01-06 01:39:41.73	\N	\N	\N
216	owo13kxqhl33gtwwuczmfbsa	plugin::content-manager.explorer.read	{}	api::nosotros.nosotros	{"fields": ["fondo", "titulo", "subtitulo", "imagenParrafo", "puv.puv", "puv.nombre", "puv.imagen", "intermedioSubtitulo", "intermedioMensaje", "mision", "vision", "razonSocial", "ruc", "nombreComercial", "tituloAutorizaciones", "autorizaciones", "tituloValores", "valores.imagen", "valores.label", "tituloPartners", "partners", "tituloCertificados", "certificados", "tituloEstadisticas", "estadisticas.redLetras", "estadisticas.grayLetras", "parrafo"], "locales": ["en", "es-PE"]}	[]	2025-01-06 01:39:41.758	2025-01-06 01:39:41.758	2025-01-06 01:39:41.758	\N	\N	\N
217	e69os3g1vcfouqrhmsrzaru0	plugin::content-manager.explorer.update	{}	api::nosotros.nosotros	{"fields": ["fondo", "titulo", "subtitulo", "imagenParrafo", "puv.puv", "puv.nombre", "puv.imagen", "intermedioSubtitulo", "intermedioMensaje", "mision", "vision", "razonSocial", "ruc", "nombreComercial", "tituloAutorizaciones", "autorizaciones", "tituloValores", "valores.imagen", "valores.label", "tituloPartners", "partners", "tituloCertificados", "certificados", "tituloEstadisticas", "estadisticas.redLetras", "estadisticas.grayLetras", "parrafo"], "locales": ["en", "es-PE"]}	[]	2025-01-06 01:39:41.769	2025-01-06 01:39:41.769	2025-01-06 01:39:41.769	\N	\N	\N
218	bglivnawpcagvf1iosgjdxkm	plugin::content-manager.explorer.create	{}	plugin::users-permissions.user	{"fields": ["username", "email", "provider", "password", "resetPasswordToken", "confirmationToken", "confirmed", "blocked", "role", "paquetes"]}	[]	2025-01-06 01:46:41.634	2025-01-06 01:46:41.634	2025-01-06 01:46:41.637	\N	\N	\N
219	nv3m85mtav3vdaadu5gwr2qe	plugin::content-manager.explorer.create	{}	api::paquetes.paquetes	{"fields": ["fondo", "featuredImage", "precio", "duracion.dias", "duracion.noches", "linkWord", "linkPdf", "linkFlyer", "campania", "gallery", "dias.titulo", "dias.item", "title", "slug", "user"], "locales": ["en", "es-PE"]}	[]	2025-01-06 01:46:41.66	2025-01-06 01:46:41.66	2025-01-06 01:46:41.661	\N	\N	\N
220	lkw5461pfrux3qu2tvbz9pyw	plugin::content-manager.explorer.read	{}	plugin::users-permissions.user	{"fields": ["username", "email", "provider", "password", "resetPasswordToken", "confirmationToken", "confirmed", "blocked", "role", "paquetes"]}	[]	2025-01-06 01:46:41.678	2025-01-06 01:46:41.678	2025-01-06 01:46:41.678	\N	\N	\N
221	uteox5d8bxch22b7b57m3bjq	plugin::content-manager.explorer.read	{}	api::paquetes.paquetes	{"fields": ["fondo", "featuredImage", "precio", "duracion.dias", "duracion.noches", "linkWord", "linkPdf", "linkFlyer", "campania", "gallery", "dias.titulo", "dias.item", "title", "slug", "user"], "locales": ["en", "es-PE"]}	[]	2025-01-06 01:46:41.693	2025-01-06 01:46:41.693	2025-01-06 01:46:41.693	\N	\N	\N
222	ipshf8iuy2gv22b9s7hmtbe8	plugin::content-manager.explorer.update	{}	plugin::users-permissions.user	{"fields": ["username", "email", "provider", "password", "resetPasswordToken", "confirmationToken", "confirmed", "blocked", "role", "paquetes"]}	[]	2025-01-06 01:46:41.705	2025-01-06 01:46:41.705	2025-01-06 01:46:41.705	\N	\N	\N
223	q2wyzkzlivok0h43c7f2xw57	plugin::content-manager.explorer.update	{}	api::paquetes.paquetes	{"fields": ["fondo", "featuredImage", "precio", "duracion.dias", "duracion.noches", "linkWord", "linkPdf", "linkFlyer", "campania", "gallery", "dias.titulo", "dias.item", "title", "slug", "user"], "locales": ["en", "es-PE"]}	[]	2025-01-06 01:46:41.717	2025-01-06 01:46:41.717	2025-01-06 01:46:41.718	\N	\N	\N
224	mrgskp38gp835frwfloy0zot	plugin::content-manager.explorer.create	{}	api::inicio.inicio	{"fields": ["tituloPaquete", "tituloDestino", "tituloFormulario", "subtituloFormulario", "galleriaCarousel", "faq.pregunta", "faq.respuesta"], "locales": ["en", "es-PE"]}	[]	2025-01-06 03:03:56.87	2025-01-06 03:03:56.87	2025-01-06 03:03:56.871	\N	\N	\N
225	v1n5m5madinkzdejy358k92i	plugin::content-manager.explorer.read	{}	api::inicio.inicio	{"fields": ["tituloPaquete", "tituloDestino", "tituloFormulario", "subtituloFormulario", "galleriaCarousel", "faq.pregunta", "faq.respuesta"], "locales": ["en", "es-PE"]}	[]	2025-01-06 03:03:56.897	2025-01-06 03:03:56.897	2025-01-06 03:03:56.897	\N	\N	\N
226	nfoux5tikpujvcq614w8wacg	plugin::content-manager.explorer.update	{}	api::inicio.inicio	{"fields": ["tituloPaquete", "tituloDestino", "tituloFormulario", "subtituloFormulario", "galleriaCarousel", "faq.pregunta", "faq.respuesta"], "locales": ["en", "es-PE"]}	[]	2025-01-06 03:03:56.91	2025-01-06 03:03:56.91	2025-01-06 03:03:56.91	\N	\N	\N
227	e46hsmcg1mjwostryho3oju6	plugin::content-manager.explorer.delete	{}	api::inicio.inicio	{"locales": ["en", "es-PE"]}	[]	2025-01-06 03:03:56.923	2025-01-06 03:03:56.923	2025-01-06 03:03:56.923	\N	\N	\N
228	kpyulz4otweoug355i3cb5ws	plugin::content-manager.explorer.publish	{}	api::inicio.inicio	{"locales": ["en", "es-PE"]}	[]	2025-01-06 03:03:56.937	2025-01-06 03:03:56.937	2025-01-06 03:03:56.938	\N	\N	\N
229	dz6o9vo4g1sv4lh1395z67wm	plugin::content-manager.explorer.create	{}	api::destino.destino	{"fields": ["name", "background", "backgroundMobile", "backgroundDestinoPage"]}	[]	2025-01-06 03:14:55.207	2025-01-06 03:14:55.207	2025-01-06 03:14:55.209	\N	\N	\N
230	fz1cq7n7qxtq8zwfksvah6bm	plugin::content-manager.explorer.read	{}	api::destino.destino	{"fields": ["name", "background", "backgroundMobile", "backgroundDestinoPage"]}	[]	2025-01-06 03:14:55.241	2025-01-06 03:14:55.241	2025-01-06 03:14:55.241	\N	\N	\N
231	o7r50fzxu7u4h1ur8kqpsxdp	plugin::content-manager.explorer.update	{}	api::destino.destino	{"fields": ["name", "background", "backgroundMobile", "backgroundDestinoPage"]}	[]	2025-01-06 03:14:55.253	2025-01-06 03:14:55.253	2025-01-06 03:14:55.253	\N	\N	\N
232	w0biw0yiymg3eo4u37d1gs1v	plugin::content-manager.explorer.delete	{}	api::destino.destino	{}	[]	2025-01-06 03:14:55.263	2025-01-06 03:14:55.263	2025-01-06 03:14:55.264	\N	\N	\N
233	ty1uuj7tmydknkicktdkr5af	plugin::content-manager.explorer.publish	{}	api::destino.destino	{}	[]	2025-01-06 03:14:55.279	2025-01-06 03:14:55.279	2025-01-06 03:14:55.279	\N	\N	\N
237	xz1fwihrm8grme273866nt9a	plugin::content-manager.explorer.delete	{}	api::categoria.categoria	{"locales": ["en", "es-PE"]}	[]	2025-01-06 03:27:12.605	2025-01-06 03:27:12.605	2025-01-06 03:27:12.605	\N	\N	\N
238	tv4ixcs76mtiw2gyw0afkak2	plugin::content-manager.explorer.publish	{}	api::categoria.categoria	{"locales": ["en", "es-PE"]}	[]	2025-01-06 03:27:12.617	2025-01-06 03:27:12.617	2025-01-06 03:27:12.617	\N	\N	\N
239	ikwuvk88ls4njmf4amwvk9xj	plugin::content-manager.explorer.create	{}	api::categoria.categoria	{"fields": ["name", "description", "slug", "tours"], "locales": ["en", "es-PE"]}	[]	2025-01-06 03:42:10.981	2025-01-06 03:42:10.981	2025-01-06 03:42:10.982	\N	\N	\N
240	hlacd1hr1ofbou0c9ygfy7cj	plugin::content-manager.explorer.create	{}	api::tours.tours	{"fields": ["title", "fondo", "featuredImage", "precio", "duracion.dias", "duracion.noches", "linkWord", "linkPdf", "dias.titulo", "dias.item", "incluido.item", "excluido.item", "galeria", "destino", "categorias"], "locales": ["en", "es-PE"]}	[]	2025-01-06 03:42:11.004	2025-01-06 03:42:11.004	2025-01-06 03:42:11.005	\N	\N	\N
241	contx16my23rp6ri27wxd2fk	plugin::content-manager.explorer.read	{}	api::categoria.categoria	{"fields": ["name", "description", "slug", "tours"], "locales": ["en", "es-PE"]}	[]	2025-01-06 03:42:11.019	2025-01-06 03:42:11.019	2025-01-06 03:42:11.02	\N	\N	\N
242	hin08nta3zw51iiiv9t52d3t	plugin::content-manager.explorer.read	{}	api::tours.tours	{"fields": ["title", "fondo", "featuredImage", "precio", "duracion.dias", "duracion.noches", "linkWord", "linkPdf", "dias.titulo", "dias.item", "incluido.item", "excluido.item", "galeria", "destino", "categorias"], "locales": ["en", "es-PE"]}	[]	2025-01-06 03:42:11.032	2025-01-06 03:42:11.032	2025-01-06 03:42:11.032	\N	\N	\N
243	wz3wcg5q9xlpnipf2l305fue	plugin::content-manager.explorer.update	{}	api::categoria.categoria	{"fields": ["name", "description", "slug", "tours"], "locales": ["en", "es-PE"]}	[]	2025-01-06 03:42:11.045	2025-01-06 03:42:11.045	2025-01-06 03:42:11.046	\N	\N	\N
244	w49ys5of8g5m39k3a76e1m2h	plugin::content-manager.explorer.update	{}	api::tours.tours	{"fields": ["title", "fondo", "featuredImage", "precio", "duracion.dias", "duracion.noches", "linkWord", "linkPdf", "dias.titulo", "dias.item", "incluido.item", "excluido.item", "galeria", "destino", "categorias"], "locales": ["en", "es-PE"]}	[]	2025-01-06 03:42:11.055	2025-01-06 03:42:11.055	2025-01-06 03:42:11.055	\N	\N	\N
245	o63b8o7ldipqma3ypiiyz5ak	plugin::content-manager.explorer.delete	{}	api::tours.tours	{"locales": ["en", "es-PE"]}	[]	2025-01-06 03:42:11.067	2025-01-06 03:42:11.067	2025-01-06 03:42:11.068	\N	\N	\N
246	o8926lu04nn4vl82ixfaosz3	plugin::content-manager.explorer.publish	{}	api::tours.tours	{"locales": ["en", "es-PE"]}	[]	2025-01-06 03:42:11.081	2025-01-06 03:42:11.081	2025-01-06 03:42:11.081	\N	\N	\N
\.
...
--
-- Data for Name: categorias; Type: TABLE DATA; Schema: public; Owner: strapi
--

COPY public.categorias (id, document_id, name, description, slug, created_at, updated_at, published_at, created_by_id, updated_by_id, locale) FROM stdin;
\.
...
COPY public.destinos (id, document_id, name, created_at, updated_at, published_at, created_by_id, updated_by_id, locale) FROM stdin;
\.
...
1	ynn7murx202c2veqckpmh8q0	2025-01-04 22:43:56.71	2025-01-04 22:43:56.71	\N	1	1	es-PE	\N	\N	\N	\N
2	ynn7murx202c2veqckpmh8q0	2025-01-04 22:43:56.71	2025-01-04 22:43:56.71	2025-01-04 22:43:56.774	1	1	es-PE	\N	\N	\N	\N
\.
...
COPY public.paquetess (id, document_id, precio, link_word, link_pdf, link_flyer, campania, created_at, updated_at, published_at, created_by_id, updated_by_id, locale, title, slug) FROM stdin;
\.
...
--
-- Data for Name: paquetess_user_lnk; Type: TABLE DATA; Schema: public; Owner: strapi
--

COPY public.paquetess_user_lnk (id, paquetes_id, user_id, paquetes_ord) FROM stdin;
\.
...
16	plugin_content_manager_configuration_content_types::plugin::users-permissions.user	{"settings":{"bulkable":true,"filterable":true,"searchable":true,"pageSize":10,"mainField":"username","defaultSortBy":"username","defaultSortOrder":"ASC"},"metadatas":{"id":{"edit":{},"list":{"label":"id","searchable":true,"sortable":true}},"username":{"edit":{"label":"username","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"username","searchable":true,"sortable":true}},"email":{"edit":{"label":"email","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"email","searchable":true,"sortable":true}},"provider":{"edit":{"label":"provider","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"provider","searchable":true,"sortable":true}},"password":{"edit":{"label":"password","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"password","searchable":true,"sortable":true}},"resetPasswordToken":{"edit":{"label":"resetPasswordToken","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"resetPasswordToken","searchable":true,"sortable":true}},"confirmationToken":{"edit":{"label":"confirmationToken","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"confirmationToken","searchable":true,"sortable":true}},"confirmed":{"edit":{"label":"confirmed","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"confirmed","searchable":true,"sortable":true}},"blocked":{"edit":{"label":"blocked","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"blocked","searchable":true,"sortable":true}},"role":{"edit":{"label":"role","description":"","placeholder":"","visible":true,"editable":true,"mainField":"name"},"list":{"label":"role","searchable":true,"sortable":true}},"paquetes":{"edit":{"label":"paquetes","description":"","placeholder":"","visible":true,"editable":true,"mainField":"linkWord"},"list":{"label":"paquetes","searchable":false,"sortable":false}},"createdAt":{"edit":{"label":"createdAt","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"createdAt","searchable":true,"sortable":true}},"updatedAt":{"edit":{"label":"updatedAt","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"updatedAt","searchable":true,"sortable":true}},"createdBy":{"edit":{"label":"createdBy","description":"","placeholder":"","visible":false,"editable":true,"mainField":"firstname"},"list":{"label":"createdBy","searchable":true,"sortable":true}},"updatedBy":{"edit":{"label":"updatedBy","description":"","placeholder":"","visible":false,"editable":true,"mainField":"firstname"},"list":{"label":"updatedBy","searchable":true,"sortable":true}}},"layouts":{"list":["id","username","email","confirmed"],"edit":[[{"name":"username","size":6},{"name":"email","size":6}],[{"name":"password","size":6},{"name":"confirmed","size":4}],[{"name":"blocked","size":4},{"name":"role","size":6}],[{"name":"paquetes","size":6}]]},"uid":"plugin::users-permissions.user"}	object	\N	\N
...
38	plugin_content_manager_configuration_content_types::api::inicio.inicio	{"settings":{"bulkable":true,"filterable":true,"searchable":true,"pageSize":10,"mainField":"id","defaultSortBy":"tituloPaquete","defaultSortOrder":"ASC"},"metadatas":{"id":{"edit":{},"list":{"label":"id","searchable":true,"sortable":true}},"tituloPaquete":{"edit":{"label":"tituloPaquete","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"tituloPaquete","searchable":true,"sortable":true}},"tituloDestino":{"edit":{"label":"tituloDestino","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"tituloDestino","searchable":true,"sortable":true}},"tituloFormulario":{"edit":{"label":"tituloFormulario","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"tituloFormulario","searchable":true,"sortable":true}},"subtituloFormulario":{"edit":{"label":"subtituloFormulario","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"subtituloFormulario","searchable":true,"sortable":true}},"galleriaCarousel":{"edit":{"label":"galleriaCarousel","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"galleriaCarousel","searchable":false,"sortable":false}},"faq":{"edit":{"label":"Preguntas Frecuentes","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"faq","searchable":false,"sortable":false}},"createdAt":{"edit":{"label":"createdAt","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"createdAt","searchable":true,"sortable":true}},"updatedAt":{"edit":{"label":"updatedAt","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"updatedAt","searchable":true,"sortable":true}},"createdBy":{"edit":{"label":"createdBy","description":"","placeholder":"","visible":false,"editable":true,"mainField":"firstname"},"list":{"label":"createdBy","searchable":true,"sortable":true}},"updatedBy":{"edit":{"label":"updatedBy","description":"","placeholder":"","visible":false,"editable":true,"mainField":"firstname"},"list":{"label":"updatedBy","searchable":true,"sortable":true}}},"layouts":{"list":["id","tituloPaquete","tituloDestino","tituloFormulario"],"edit":[[{"name":"galleriaCarousel","size":12}],[{"name":"tituloPaquete","size":6},{"name":"tituloDestino","size":6}],[{"name":"tituloFormulario","size":6},{"name":"subtituloFormulario","size":6}],[{"name":"faq","size":12}]]},"uid":"api::inicio.inicio"}	object	\N	\N
...
46	plugin_content_manager_configuration_content_types::api::paquetes.paquetes	{"settings":{"bulkable":true,"filterable":true,"searchable":true,"pageSize":10,"mainField":"linkWord","defaultSortBy":"linkWord","defaultSortOrder":"ASC"},"metadatas":{"id":{"edit":{},"list":{"label":"id","searchable":true,"sortable":true}},"fondo":{"edit":{"label":"fondo","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"fondo","searchable":false,"sortable":false}},"featuredImage":{"edit":{"label":"featuredImage","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"featuredImage","searchable":false,"sortable":false}},"precio":{"edit":{"label":"precio","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"precio","searchable":true,"sortable":true}},"duracion":{"edit":{"label":"duracion","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"duracion","searchable":false,"sortable":false}},"linkWord":{"edit":{"label":"linkWord","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"linkWord","searchable":true,"sortable":true}},"linkPdf":{"edit":{"label":"linkPdf","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"linkPdf","searchable":true,"sortable":true}},"linkFlyer":{"edit":{"label":"linkFlyer","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"linkFlyer","searchable":true,"sortable":true}},"campania":{"edit":{"label":"campania","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"campania","searchable":true,"sortable":true}},"gallery":{"edit":{"label":"gallery","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"gallery","searchable":false,"sortable":false}},"dias":{"edit":{"label":"dias","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"dias","searchable":false,"sortable":false}},"title":{"edit":{"label":"title","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"title","searchable":true,"sortable":true}},"slug":{"edit":{"label":"slug","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"slug","searchable":true,"sortable":true}},"user":{"edit":{"label":"user","description":"","placeholder":"","visible":true,"editable":true,"mainField":"username"},"list":{"label":"user","searchable":true,"sortable":true}},"createdAt":{"edit":{"label":"createdAt","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"createdAt","searchable":true,"sortable":true}},"updatedAt":{"edit":{"label":"updatedAt","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"updatedAt","searchable":true,"sortable":true}},"createdBy":{"edit":{"label":"createdBy","description":"","placeholder":"","visible":false,"editable":true,"mainField":"firstname"},"list":{"label":"createdBy","searchable":true,"sortable":true}},"updatedBy":{"edit":{"label":"updatedBy","description":"","placeholder":"","visible":false,"editable":true,"mainField":"firstname"},"list":{"label":"updatedBy","searchable":true,"sortable":true}}},"layouts":{"list":["id","fondo","featuredImage","precio"],"edit":[[{"name":"fondo","size":6},{"name":"featuredImage","size":6}],[{"name":"precio","size":4}],[{"name":"duracion","size":12}],[{"name":"linkWord","size":6},{"name":"linkPdf","size":6}],[{"name":"linkFlyer","size":6},{"name":"campania","size":4}],[{"name":"gallery","size":6}],[{"name":"dias","size":12}],[{"name":"title","size":6},{"name":"slug","size":6}],[{"name":"user","size":6}]]},"uid":"api::paquetes.paquetes"}	object	\N	\N
...
39	plugin_content_manager_configuration_content_types::api::nosotros.nosotros	{"settings":{"bulkable":true,"filterable":true,"searchable":true,"pageSize":10,"mainField":"titulo","defaultSortBy":"titulo","defaultSortOrder":"ASC"},"metadatas":{"id":{"edit":{},"list":{"label":"id","searchable":true,"sortable":true}},"fondo":{"edit":{"label":"fondo","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"fondo","searchable":false,"sortable":false}},"titulo":{"edit":{"label":"titulo","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"titulo","searchable":true,"sortable":true}},"subtitulo":{"edit":{"label":"subtitulo","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"subtitulo","searchable":true,"sortable":true}},"imagenParrafo":{"edit":{"label":"imagenParrafo","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"imagenParrafo","searchable":false,"sortable":false}},"puv":{"edit":{"label":"Promesa Unica de Valor","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"puv","searchable":false,"sortable":false}},"intermedioSubtitulo":{"edit":{"label":"intermedioSubtitulo","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"intermedioSubtitulo","searchable":true,"sortable":true}},"intermedioMensaje":{"edit":{"label":"intermedioMensaje","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"intermedioMensaje","searchable":true,"sortable":true}},"mision":{"edit":{"label":"mision","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"mision","searchable":true,"sortable":true}},"vision":{"edit":{"label":"vision","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"vision","searchable":true,"sortable":true}},"razonSocial":{"edit":{"label":"razonSocial","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"razonSocial","searchable":true,"sortable":true}},"ruc":{"edit":{"label":"ruc","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"ruc","searchable":true,"sortable":true}},"nombreComercial":{"edit":{"label":"nombreComercial","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"nombreComercial","searchable":true,"sortable":true}},"tituloAutorizaciones":{"edit":{"label":"tituloAutorizaciones","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"tituloAutorizaciones","searchable":true,"sortable":true}},"autorizaciones":{"edit":{"label":"autorizaciones","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"autorizaciones","searchable":false,"sortable":false}},"tituloValores":{"edit":{"label":"tituloValores","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"tituloValores","searchable":true,"sortable":true}},"valores":{"edit":{"label":"valores","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"valores","searchable":false,"sortable":false}},"tituloPartners":{"edit":{"label":"tituloPartners","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"tituloPartners","searchable":true,"sortable":true}},"partners":{"edit":{"label":"partners","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"partners","searchable":false,"sortable":false}},"tituloCertificados":{"edit":{"label":"tituloCertificados","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"tituloCertificados","searchable":true,"sortable":true}},"certificados":{"edit":{"label":"certificados","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"certificados","searchable":false,"sortable":false}},"tituloEstadisticas":{"edit":{"label":"tituloEstadisticas","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"tituloEstadisticas","searchable":true,"sortable":true}},"estadisticas":{"edit":{"label":"estadisticas","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"estadisticas","searchable":false,"sortable":false}},"parrafo":{"edit":{"label":"parrafo","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"parrafo","searchable":false,"sortable":false}},"createdAt":{"edit":{"label":"createdAt","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"createdAt","searchable":true,"sortable":true}},"updatedAt":{"edit":{"label":"updatedAt","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"updatedAt","searchable":true,"sortable":true}},"createdBy":{"edit":{"label":"createdBy","description":"","placeholder":"","visible":false,"editable":true,"mainField":"firstname"},"list":{"label":"createdBy","searchable":true,"sortable":true}},"updatedBy":{"edit":{"label":"updatedBy","description":"","placeholder":"","visible":false,"editable":true,"mainField":"firstname"},"list":{"label":"updatedBy","searchable":true,"sortable":true}}},"layouts":{"list":["id","fondo","titulo","subtitulo"],"edit":[[{"name":"fondo","size":6},{"name":"titulo","size":6}],[{"name":"subtitulo","size":6}],[{"name":"imagenParrafo","size":6}],[{"name":"parrafo","size":12}],[{"name":"puv","size":12}],[{"name":"intermedioSubtitulo","size":6},{"name":"intermedioMensaje","size":6}],[{"name":"mision","size":6},{"name":"vision","size":6}],[{"name":"razonSocial","size":6},{"name":"ruc","size":6}],[{"name":"nombreComercial","size":6},{"name":"tituloCertificados","size":6}],[{"name":"tituloAutorizaciones","size":6},{"name":"autorizaciones","size":6}],[{"name":"tituloValores","size":6}],[{"name":"valores","size":12}],[{"name":"certificados","size":6},{"name":"tituloPartners","size":6}],[{"name":"partners","size":6}],[{"name":"tituloEstadisticas","size":6}],[{"name":"estadisticas","size":12}]]},"uid":"api::nosotros.nosotros"}	object	\N	\N
56	plugin_content_manager_configuration_content_types::api::destino.destino	{"settings":{"bulkable":true,"filterable":true,"searchable":true,"pageSize":10,"mainField":"name","defaultSortBy":"name","defaultSortOrder":"ASC"},"metadatas":{"id":{"edit":{},"list":{"label":"id","searchable":true,"sortable":true}},"name":{"edit":{"label":"name","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"name","searchable":true,"sortable":true}},"background":{"edit":{"label":"background","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"background","searchable":false,"sortable":false}},"backgroundMobile":{"edit":{"label":"backgroundMobile","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"backgroundMobile","searchable":false,"sortable":false}},"backgroundDestinoPage":{"edit":{"label":"backgroundDestinoPage","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"backgroundDestinoPage","searchable":false,"sortable":false}},"createdAt":{"edit":{"label":"createdAt","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"createdAt","searchable":true,"sortable":true}},"updatedAt":{"edit":{"label":"updatedAt","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"updatedAt","searchable":true,"sortable":true}},"createdBy":{"edit":{"label":"createdBy","description":"","placeholder":"","visible":false,"editable":true,"mainField":"firstname"},"list":{"label":"createdBy","searchable":true,"sortable":true}},"updatedBy":{"edit":{"label":"updatedBy","description":"","placeholder":"","visible":false,"editable":true,"mainField":"firstname"},"list":{"label":"updatedBy","searchable":true,"sortable":true}}},"layouts":{"list":["id","name","background","backgroundMobile"],"edit":[[{"name":"name","size":6},{"name":"background","size":6}],[{"name":"backgroundMobile","size":6},{"name":"backgroundDestinoPage","size":6}]]},"uid":"api::destino.destino"}	object	\N	\N
58	plugin_content_manager_configuration_content_types::api::tours.tours	{"settings":{"bulkable":true,"filterable":true,"searchable":true,"pageSize":10,"mainField":"title","defaultSortBy":"title","defaultSortOrder":"ASC"},"metadatas":{"id":{"edit":{},"list":{"label":"id","searchable":true,"sortable":true}},"title":{"edit":{"label":"title","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"title","searchable":true,"sortable":true}},"fondo":{"edit":{"label":"fondo","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"fondo","searchable":false,"sortable":false}},"featuredImage":{"edit":{"label":"featuredImage","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"featuredImage","searchable":false,"sortable":false}},"precio":{"edit":{"label":"precio","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"precio","searchable":true,"sortable":true}},"duracion":{"edit":{"label":"duracion","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"duracion","searchable":false,"sortable":false}},"linkWord":{"edit":{"label":"linkWord","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"linkWord","searchable":true,"sortable":true}},"linkPdf":{"edit":{"label":"linkPdf","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"linkPdf","searchable":true,"sortable":true}},"dias":{"edit":{"label":"dias","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"dias","searchable":false,"sortable":false}},"incluido":{"edit":{"label":"incluido","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"incluido","searchable":false,"sortable":false}},"excluido":{"edit":{"label":"excluido","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"excluido","searchable":false,"sortable":false}},"galeria":{"edit":{"label":"galeria","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"galeria","searchable":false,"sortable":false}},"destino":{"edit":{"label":"destino","description":"","placeholder":"","visible":true,"editable":true,"mainField":"name"},"list":{"label":"destino","searchable":true,"sortable":true}},"categorias":{"edit":{"label":"categorias","description":"","placeholder":"","visible":true,"editable":true,"mainField":"name"},"list":{"label":"categorias","searchable":false,"sortable":false}},"createdAt":{"edit":{"label":"createdAt","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"createdAt","searchable":true,"sortable":true}},"updatedAt":{"edit":{"label":"updatedAt","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"updatedAt","searchable":true,"sortable":true}},"createdBy":{"edit":{"label":"createdBy","description":"","placeholder":"","visible":false,"editable":true,"mainField":"firstname"},"list":{"label":"createdBy","searchable":true,"sortable":true}},"updatedBy":{"edit":{"label":"updatedBy","description":"","placeholder":"","visible":false,"editable":true,"mainField":"firstname"},"list":{"label":"updatedBy","searchable":true,"sortable":true}}},"layouts":{"list":["id","title","fondo","featuredImage"],"edit":[[{"name":"title","size":6},{"name":"fondo","size":6}],[{"name":"featuredImage","size":6},{"name":"precio","size":4}],[{"name":"duracion","size":12}],[{"name":"linkWord","size":6},{"name":"linkPdf","size":6}],[{"name":"dias","size":12}],[{"name":"incluido","size":12}],[{"name":"excluido","size":12}],[{"name":"galeria","size":6},{"name":"destino","size":6}],[{"name":"categorias","size":6}]]},"uid":"api::tours.tours"}	object	\N	\N
57	plugin_content_manager_configuration_content_types::api::categoria.categoria	{"settings":{"bulkable":true,"filterable":true,"searchable":true,"pageSize":10,"mainField":"name","defaultSortBy":"name","defaultSortOrder":"ASC"},"metadatas":{"id":{"edit":{},"list":{"label":"id","searchable":true,"sortable":true}},"name":{"edit":{"label":"name","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"name","searchable":true,"sortable":true}},"description":{"edit":{"label":"description","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"description","searchable":true,"sortable":true}},"slug":{"edit":{"label":"slug","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"slug","searchable":true,"sortable":true}},"tours":{"edit":{"label":"tours","description":"","placeholder":"","visible":true,"editable":true,"mainField":"title"},"list":{"label":"tours","searchable":false,"sortable":false}},"createdAt":{"edit":{"label":"createdAt","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"createdAt","searchable":true,"sortable":true}},"updatedAt":{"edit":{"label":"updatedAt","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"updatedAt","searchable":true,"sortable":true}},"createdBy":{"edit":{"label":"createdBy","description":"","placeholder":"","visible":false,"editable":true,"mainField":"firstname"},"list":{"label":"createdBy","searchable":true,"sortable":true}},"updatedBy":{"edit":{"label":"updatedBy","description":"","placeholder":"","visible":false,"editable":true,"mainField":"firstname"},"list":{"label":"updatedBy","searchable":true,"sortable":true}}},"layouts":{"list":["id","name","description","slug"],"edit":[[{"name":"name","size":6},{"name":"description","size":6}],[{"name":"slug","size":6},{"name":"tours","size":6}]]},"uid":"api::categoria.categoria"}	object	\N	\N
\.
...
--
-- Data for Name: tourss; Type: TABLE DATA; Schema: public; Owner: strapi
--

COPY public.tourss (id, document_id, title, precio, link_word, link_pdf, created_at, updated_at, published_at, created_by_id, updated_by_id, locale) FROM stdin;
\.


--
-- Data for Name: tourss_categorias_lnk; Type: TABLE DATA; Schema: public; Owner: strapi
--

COPY public.tourss_categorias_lnk (id, tours_id, categoria_id, categoria_ord, tours_ord) FROM stdin;
\.


--
-- Data for Name: tourss_cmps; Type: TABLE DATA; Schema: public; Owner: strapi
--

COPY public.tourss_cmps (id, entity_id, cmp_id, component_type, field, "order") FROM stdin;
\.


--
-- Data for Name: tourss_destino_lnk; Type: TABLE DATA; Schema: public; Owner: strapi
--

COPY public.tourss_destino_lnk (id, tours_id, destino_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.admin_permissions_id_seq', 246, true);
...
SELECT pg_catalog.setval('public.admin_permissions_role_lnk_id_seq', 246, true);
...
--
-- Name: categorias_id_seq; Type: SEQUENCE SET; Schema: public; Owner: strapi
--
...
--
-- Name: paquetess_user_lnk_id_seq; Type: SEQUENCE SET; Schema: public; Owner: strapi
--

SELECT pg_catalog.setval('public.paquetess_user_lnk_id_seq', 1, false);
...
--
-- Name: tourss_categorias_lnk_id_seq; Type: SEQUENCE SET; Schema: public; Owner: strapi
--

SELECT pg_catalog.setval('public.tourss_categorias_lnk_id_seq', 1, false);


--
-- Name: tourss_cmps_id_seq; Type: SEQUENCE SET; Schema: public; Owner: strapi
--

SELECT pg_catalog.setval('public.tourss_cmps_id_seq', 1, false);


--
-- Name: tourss_destino_lnk_id_seq; Type: SEQUENCE SET; Schema: public; Owner: strapi
--

SELECT pg_catalog.setval('public.tourss_destino_lnk_id_seq', 1, false);


--
-- Name: tourss_id_seq; Type: SEQUENCE SET; Schema: public; Owner: strapi
--

SELECT pg_catalog.setval('public.tourss_id_seq', 1, false);
...
--
-- Name: categorias categorias_pkey; Type: CONSTRAINT; Schema: public; Owner: strapi
--
...
--
-- Name: paquetess_user_lnk paquetess_user_lnk_pkey; Type: CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.paquetess_user_lnk
    ADD CONSTRAINT paquetess_user_lnk_pkey PRIMARY KEY (id);


--
-- Name: paquetess_user_lnk paquetess_user_lnk_uq; Type: CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.paquetess_user_lnk
    ADD CONSTRAINT paquetess_user_lnk_uq UNIQUE (paquetes_id, user_id);
...
--
-- Name: tourss_categorias_lnk tourss_categorias_lnk_pkey; Type: CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.tourss_categorias_lnk
    ADD CONSTRAINT tourss_categorias_lnk_pkey PRIMARY KEY (id);


--
-- Name: tourss_categorias_lnk tourss_categorias_lnk_uq; Type: CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.tourss_categorias_lnk
    ADD CONSTRAINT tourss_categorias_lnk_uq UNIQUE (tours_id, categoria_id);


--
-- Name: tourss_cmps tourss_cmps_pkey; Type: CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.tourss_cmps
    ADD CONSTRAINT tourss_cmps_pkey PRIMARY KEY (id);


--
-- Name: tourss_destino_lnk tourss_destino_lnk_pkey; Type: CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.tourss_destino_lnk
    ADD CONSTRAINT tourss_destino_lnk_pkey PRIMARY KEY (id);


--
-- Name: tourss_destino_lnk tourss_destino_lnk_uq; Type: CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.tourss_destino_lnk
    ADD CONSTRAINT tourss_destino_lnk_uq UNIQUE (tours_id, destino_id);


--
-- Name: tourss tourss_pkey; Type: CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.tourss
    ADD CONSTRAINT tourss_pkey PRIMARY KEY (id);


--
-- Name: tourss_cmps tourss_uq; Type: CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.tourss_cmps
    ADD CONSTRAINT tourss_uq UNIQUE (entity_id, cmp_id, field, component_type);
...
--
-- Name: categorias_created_by_id_fk; Type: INDEX; Schema: public; Owner: strapi
--

CREATE INDEX categorias_created_by_id_fk ON public.categorias USING btree (created_by_id);


--
-- Name: categorias_documents_idx; Type: INDEX; Schema: public; Owner: strapi
--

CREATE INDEX categorias_documents_idx ON public.categorias USING btree (document_id, locale, published_at);


--
-- Name: categorias_updated_by_id_fk; Type: INDEX; Schema: public; Owner: strapi
--

CREATE INDEX categorias_updated_by_id_fk ON public.categorias USING btree (updated_by_id);
...
--
-- Name: destinos_documents_idx; Type: INDEX; Schema: public; Owner: strapi
--

CREATE INDEX destinos_documents_idx ON public.destinos USING btree (document_id, locale, published_at);
...
--
-- Name: paquetess_user_lnk_fk; Type: INDEX; Schema: public; Owner: strapi
--

CREATE INDEX paquetess_user_lnk_fk ON public.paquetess_user_lnk USING btree (paquetes_id);


--
-- Name: paquetess_user_lnk_ifk; Type: INDEX; Schema: public; Owner: strapi
--

CREATE INDEX paquetess_user_lnk_ifk ON public.paquetess_user_lnk USING btree (user_id);


--
-- Name: paquetess_user_lnk_oifk; Type: INDEX; Schema: public; Owner: strapi
--

CREATE INDEX paquetess_user_lnk_oifk ON public.paquetess_user_lnk USING btree (paquetes_ord);
...
--
-- Name: tourss_categorias_lnk_fk; Type: INDEX; Schema: public; Owner: strapi
--

CREATE INDEX tourss_categorias_lnk_fk ON public.tourss_categorias_lnk USING btree (tours_id);


--
-- Name: tourss_categorias_lnk_ifk; Type: INDEX; Schema: public; Owner: strapi
--

CREATE INDEX tourss_categorias_lnk_ifk ON public.tourss_categorias_lnk USING btree (categoria_id);


--
-- Name: tourss_categorias_lnk_ofk; Type: INDEX; Schema: public; Owner: strapi
--

CREATE INDEX tourss_categorias_lnk_ofk ON public.tourss_categorias_lnk USING btree (categoria_ord);


--
-- Name: tourss_categorias_lnk_oifk; Type: INDEX; Schema: public; Owner: strapi
--

CREATE INDEX tourss_categorias_lnk_oifk ON public.tourss_categorias_lnk USING btree (tours_ord);


--
-- Name: tourss_component_type_idx; Type: INDEX; Schema: public; Owner: strapi
--

CREATE INDEX tourss_component_type_idx ON public.tourss_cmps USING btree (component_type);


--
-- Name: tourss_created_by_id_fk; Type: INDEX; Schema: public; Owner: strapi
--

CREATE INDEX tourss_created_by_id_fk ON public.tourss USING btree (created_by_id);


--
-- Name: tourss_destino_lnk_fk; Type: INDEX; Schema: public; Owner: strapi
--

CREATE INDEX tourss_destino_lnk_fk ON public.tourss_destino_lnk USING btree (tours_id);


--
-- Name: tourss_destino_lnk_ifk; Type: INDEX; Schema: public; Owner: strapi
--

CREATE INDEX tourss_destino_lnk_ifk ON public.tourss_destino_lnk USING btree (destino_id);


--
-- Name: tourss_documents_idx; Type: INDEX; Schema: public; Owner: strapi
--

CREATE INDEX tourss_documents_idx ON public.tourss USING btree (document_id, locale, published_at);


--
-- Name: tourss_entity_fk; Type: INDEX; Schema: public; Owner: strapi
--

CREATE INDEX tourss_entity_fk ON public.tourss_cmps USING btree (entity_id);


--
-- Name: tourss_field_idx; Type: INDEX; Schema: public; Owner: strapi
--

CREATE INDEX tourss_field_idx ON public.tourss_cmps USING btree (field);


--
-- Name: tourss_updated_by_id_fk; Type: INDEX; Schema: public; Owner: strapi
--

CREATE INDEX tourss_updated_by_id_fk ON public.tourss USING btree (updated_by_id);
...
--
-- Name: categorias categorias_created_by_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: strapi
--
...
--
-- Name: categorias categorias_updated_by_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: strapi
--
...
--
-- Name: paquetess_user_lnk paquetess_user_lnk_fk; Type: FK CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.paquetess_user_lnk
    ADD CONSTRAINT paquetess_user_lnk_fk FOREIGN KEY (paquetes_id) REFERENCES public.paquetess(id) ON DELETE CASCADE;


--
-- Name: paquetess_user_lnk paquetess_user_lnk_ifk; Type: FK CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.paquetess_user_lnk
    ADD CONSTRAINT paquetess_user_lnk_ifk FOREIGN KEY (user_id) REFERENCES public.up_users(id) ON DELETE CASCADE;
...
--
-- Name: tourss_categorias_lnk tourss_categorias_lnk_fk; Type: FK CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.tourss_categorias_lnk
    ADD CONSTRAINT tourss_categorias_lnk_fk FOREIGN KEY (tours_id) REFERENCES public.tourss(id) ON DELETE CASCADE;


--
-- Name: tourss_categorias_lnk tourss_categorias_lnk_ifk; Type: FK CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.tourss_categorias_lnk
    ADD CONSTRAINT tourss_categorias_lnk_ifk FOREIGN KEY (categoria_id) REFERENCES public.categorias(id) ON DELETE CASCADE;


--
-- Name: tourss tourss_created_by_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.tourss
    ADD CONSTRAINT tourss_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES public.admin_users(id) ON DELETE SET NULL;


--
-- Name: tourss_destino_lnk tourss_destino_lnk_fk; Type: FK CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.tourss_destino_lnk
    ADD CONSTRAINT tourss_destino_lnk_fk FOREIGN KEY (tours_id) REFERENCES public.tourss(id) ON DELETE CASCADE;


--
-- Name: tourss_destino_lnk tourss_destino_lnk_ifk; Type: FK CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.tourss_destino_lnk
    ADD CONSTRAINT tourss_destino_lnk_ifk FOREIGN KEY (destino_id) REFERENCES public.destinos(id) ON DELETE CASCADE;


--
-- Name: tourss_cmps tourss_entity_fk; Type: FK CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.tourss_cmps
    ADD CONSTRAINT tourss_entity_fk FOREIGN KEY (entity_id) REFERENCES public.tourss(id) ON DELETE CASCADE;


--
-- Name: tourss tourss_updated_by_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.tourss
    ADD CONSTRAINT tourss_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES public.admin_users(id) ON DELETE SET NULL;
