...
SELECT pg_catalog.setval('public.admin_permissions_id_seq', 233, true);
...
SELECT pg_catalog.setval('public.admin_permissions_role_lnk_id_seq', 233, true);
